...
class Settings:
    ...
    # OpenAI Realtime is a conversation transport only. The API key stays
    # server-side and every operational function call is revalidated by the
    # existing NORTHMINE Runtime/RBAC pipeline.
