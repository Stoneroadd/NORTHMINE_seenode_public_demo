...
class LiveSession:
    ...
    __slots__ = (
        ...
        "demo_mode", "demo_scenario_id", "demo_fixture_id",
    )
    ...
    def __init__(self, session: AgentSession):
        ...
        # Agent Demo Tour: contexto efimero y explícitamente autorizado.
        # Nunca se persiste ni cambia las capacidades disponibles.
        self.demo_mode: str | None = None
        self.demo_scenario_id: str | None = None
        self.demo_fixture_id: str | None = None
