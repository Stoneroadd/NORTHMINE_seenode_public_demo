# Activos de la landing SaaS

## Proporcionados por el propietario

- `hero-dozer-openpit.webp`: imagen entregada por el propietario de NORTHMINE
...
- `decision-pit-blue-hour.webp`: imagen original generada para NORTHMINE con
  la herramienta integrada de generación de imágenes de OpenAI. Representa
  una operación minera sintética y no corresponde a una faena real.

Ninguno de estos activos se presenta como captura del producto ni como
evidencia de una operación o cliente específico.
