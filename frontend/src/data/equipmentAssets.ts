...
const equipmentById: Record<string, EquipmentAsset> = {
  ...
  'PALA-DEMO-01': { image: 'pala_komatsu.webp', label: 'Pala Demo 01', type: 'pala' },
  EX3517: { image: 'pala_komatsu.webp', label: 'Pala Komatsu EX3517', type: 'pala' },
  EX3470: { image: 'pala_komatsu.webp', label: 'Pala Komatsu EX3470', type: 'pala' },
  EX3420: { image: 'pala_cat390.webp', label: 'Pala CAT EX3420', type: 'pala' },
  EX09: { image: 'pala_komatsu.webp', label: 'Pala Komatsu EX09', type: 'pala' },
  CF3672: { image: 'cargador_cat.webp', label: 'Cargador CAT CF3672', type: 'cargador' },
  CF3449: { image: 'cargador_cat.webp', label: 'Cargador CAT CF3449', type: 'cargador' },
  CF3589: { image: 'cargador_cat.webp', label: 'Cargador CAT CF3589', type: 'cargador' },
  CF8007: { image: 'cargador_cat.webp', label: 'Cargador CAT CF8007', type: 'cargador' },
  CF0007: { image: 'cargador_cat.webp', label: 'Cargador CAT CF0007', type: 'cargador' },
  ...
  ALJIBE: { image: 'aljibe.webp', label: 'Aljibe', type: 'auxiliar' },
...
const equipmentByModel: Record<string, EquipmentAsset> = {
  CAT793F: { image: 'camion_cat793f.webp', label: 'Camion CAT 793F', type: 'camion' },
  CAT793D: { image: 'camion_cat793f.webp', label: 'Camion CAT 793D', type: 'camion' },
  CAT789D: { image: 'camion_cat793f.webp', label: 'Camion CAT 789D', type: 'camion' },
  KOM980E: { image: 'camion_komatsu980.webp', label: 'Camion Komatsu 980E', type: 'camion' },
  'KOM980E-5': { image: 'camion_komatsu980.webp', label: 'Camion Komatsu 980E-5', type: 'camion' },
  KOM830E: { image: 'camion_komatsu980.webp', label: 'Camion Komatsu 830E', type: 'camion' },
}

const fallbackByType: Record<EquipmentType, string> = {
  pala: 'pala_komatsu.webp',
  cargador: 'cargador_cat.webp',
  camion: 'camion_cat793f.webp',
  perforadora: 'perforadora.png',
  dozer: 'bulldozer.png',
  auxiliar: 'motoniveladora.png',
  desconocido: 'camion_cat793f.webp',
}
