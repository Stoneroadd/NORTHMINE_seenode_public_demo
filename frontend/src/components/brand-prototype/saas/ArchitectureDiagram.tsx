  ...
  return (
    <section ref={scope} className="ns-arch" aria-labelledby="ns-arch-title">
      <div className="ns-saas__shell">
        <div className="ns-arch__head" data-arch-reveal>
        ...
        <ol className="ns-arch__stages" aria-label={architecture.title}>
          {architecture.stages.map((stage, index) => (
            <li key={stage.label} className="ns-arch__stage" data-arch-reveal>
              <div className="ns-arch__node">
                ...
                {index < architecture.stages.length - 1 && (
                  <svg viewBox="0 0 24 64" aria-hidden="true" className="ns-arch__connector">
                    <line x1="12" y1="0" x2="12" y2="52" stroke="currentColor" strokeWidth="1" />
                    <path d="M6 46 L12 56 L18 46" fill="none" stroke="currentColor" strokeWidth="1" />
                  </svg>
                )}
              </div>
              <div className="ns-arch__copy">
                <h3>{stage.label}</h3>
                <p>{stage.sublabel}</p>
              </div>
            </li>
        ...
        <p className="ns-arch__note" data-arch-reveal>
          {architecture.note}
        </p>
      </div>
    </section>
