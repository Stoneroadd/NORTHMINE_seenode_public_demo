...
export const mindmap3dT: ModuleDict<MindMap3dT> = {
  es: {
    ...
    page_loading_desc: 'Consultando información operacional con fuente real o estado parcial declarado.',
  ...
  en: {
    ...
    page_loading_desc: 'Querying operational information with a real source or declared partial state.',
  ...
  de: {
    ...
    page_loading_desc: 'Betriebsinformationen mit realer Quelle oder deklariertem Teilstatus werden abgefragt.',
