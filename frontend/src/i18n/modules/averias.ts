...
export const averiasT: ModuleDict<AveriasT> = {
  es: {
    ...
    mail_sync_no_config: 'La sincronizacion de correo de averias no esta configurada para este entorno.',
  ...
  en: {
    ...
    mail_sync_no_config: 'Breakdown mail sync is not configured for this environment.',
  ...
  de: {
    ...
    mail_sync_no_config: 'Die Mail-Synchronisierung fuer Stoerungen ist fuer diese Umgebung nicht konfiguriert.',
