...
export const operatorRankingDrawerT: ModuleDict<OperatorRankingDrawerT> = {
  es: {
    ...
    detalle_no_disponible_titulo: 'Detalle adicional no disponible',
    detalle_no_disponible_desc: 'Se muestran los datos principales disponibles. El desglose fino aún no está disponible.',
  ...
  en: {
    ...
    detalle_no_disponible_titulo: 'Additional detail unavailable',
    detalle_no_disponible_desc: 'The main available data is shown. The fine-grained breakdown is not available yet.',
  ...
  de: {
    ...
    detalle_no_disponible_titulo: 'Zusätzliche Details nicht verfügbar',
    detalle_no_disponible_desc: 'Die wichtigsten verfügbaren Daten werden angezeigt. Die detaillierte Aufschlüsselung ist noch nicht verfügbar.',
