...
export const cockpitT: ModuleDict<CockpitT> = {
  es: {
    ...
    fair_comparison_sin_respuesta: 'No hay respuesta de NORTHMINE',
    ...
    error_demo_suffix: ' Los datos de demostración solo se muestran en un contexto autorizado.',
    ...
    partial_banner: (items) => `Datos parciales: ${items} no vienen en NORTHMINE. No se inventan valores.`,
    ...
    kpi_no_informado_api: 'No informado por la fuente',
    ...
    estado_caex_empty: 'Sin detalle CAEX informado por NORTHMINE',
    estado_palas_title: 'Estado Palas',
    estado_palas_empty: 'Sin palas informadas por NORTHMINE',
    ...
    fleet_empty: 'Sin resumen por equipo en NORTHMINE',
    ...
    prod_table_empty: 'Sin datos horarios en NORTHMINE',
    ...
    profit_loading_body: 'Cargando NORTHMINE',
    ...
    profit_sin_respuesta: 'Sin respuesta de NORTHMINE',
    ...
    dispatcher_loading_body: 'Cargando NORTHMINE',
    ...
    dispatcher_sin_respuesta: 'Sin respuesta de NORTHMINE',
    ...
    loading_modal_no_hourly_data: 'NORTHMINE no entrego serie hora a hora para esta UC. Se mantiene el total del turno sin inventar datos.',
    ...
    monthly_loading_body: 'Cargando NORTHMINE',
    ...
    monthly_sin_respuesta: 'Sin respuesta de NORTHMINE',
    ...
    hidden_loss_loading_body: 'Cargando NORTHMINE',
    ...
    hidden_loss_sin_respuesta: 'Sin respuesta de NORTHMINE',
    ...
    nlp_loading_body: 'Cargando NORTHMINE',
    ...
    nlp_sin_respuesta: 'Sin respuesta de NORTHMINE',
    ...
    audit_loading_body: 'Cargando NORTHMINE',
    ...
    audit_sin_respuesta: 'Sin respuesta de NORTHMINE',
    ...
    sc_no_data_detail: (id) => `NORTHMINE no entrego detalle horario para ${id}. No se inventan datos.`,
    sc_col_slot: 'Slot',
  ...
  en: {
    ...
    fair_comparison_sin_respuesta: 'No response from NORTHMINE',
    ...
    error_demo_suffix: ' Demonstration data is only shown in an authorized context.',
    ...
    partial_banner: (items) => `Partial data: ${items} do not come from NORTHMINE. Values are not invented.`,
    ...
    kpi_no_informado_api: 'Not reported by the source',
    ...
    estado_caex_empty: 'No CAEX detail reported by NORTHMINE',
    estado_palas_title: 'Loader status',
    estado_palas_empty: 'No loaders reported by NORTHMINE',
    decision_intelligence_kicker: 'Decision intelligence',
    ...
    fleet_empty: 'No equipment summary in NORTHMINE',
    ...
    prod_table_empty: 'No hourly data in NORTHMINE',
    ...
    profit_loading_body: 'Loading NORTHMINE',
    ...
    profit_sin_respuesta: 'No response from NORTHMINE',
    ...
    dispatcher_loading_body: 'Loading NORTHMINE',
    ...
    dispatcher_sin_respuesta: 'No response from NORTHMINE',
    ...
    loading_modal_peak: (hour) => `Peak ${hour}`,
    loading_modal_no_hourly_data: 'NORTHMINE did not return an hourly series for this UC. The shift total is kept without inventing data.',
    ...
    monthly_loading_body: 'Loading NORTHMINE',
    ...
    monthly_sin_respuesta: 'No response from NORTHMINE',
    ...
    hidden_loss_loading_body: 'Loading NORTHMINE',
    ...
    hidden_loss_sin_respuesta: 'No response from NORTHMINE',
    ...
    nlp_loading_body: 'Loading NORTHMINE',
    ...
    nlp_sin_respuesta: 'No response from NORTHMINE',
    ...
    audit_loading_body: 'Loading NORTHMINE',
    ...
    audit_sin_respuesta: 'No response from NORTHMINE',
    ...
    sc_no_data_detail: (id) => `NORTHMINE did not return hourly detail for ${id}. Data is not invented.`,
    sc_col_slot: 'Slot',
  ...
  de: {
    ...
    fair_comparison_sin_respuesta: 'Keine Antwort von NORTHMINE',
    ...
    partial_banner: (items) => `Teilweise Daten: ${items} stammen nicht aus NORTHMINE. Es werden keine Werte erfunden.`,
    ...
    kpi_no_informado_api: 'Von der Quelle nicht gemeldet',
    ...
    estado_caex_title: 'CAEX-Status',
    estado_caex_empty: 'Keine CAEX-Details von NORTHMINE gemeldet.',
    estado_palas_title: 'Baggerstatus',
    estado_palas_empty: 'Keine Bagger von NORTHMINE gemeldet.',
    ...
    fleet_empty: 'Keine Anlagenzusammenfassung in NORTHMINE',
    ...
    prod_table_empty: 'Keine stündlichen Daten in NORTHMINE',
    ...
    profit_loading_body: 'NORTHMINE wird geladen...',
    ...
    profit_sin_respuesta: 'Keine Antwort von NORTHMINE',
    ...
    dispatcher_loading_body: 'NORTHMINE wird geladen...',
    ...
    dispatcher_sin_respuesta: 'Keine Antwort von NORTHMINE',
    ...
    loading_modal_peak: (hour) => `Peak ${hour}`,
    loading_modal_no_hourly_data: 'NORTHMINE hat für diese UC keine stündliche Reihe geliefert. Die Schichtsumme wird beibehalten, ohne Daten zu erfinden.',
    ...
    monthly_loading_body: 'NORTHMINE wird geladen...',
    ...
    monthly_sin_respuesta: 'Keine Antwort von NORTHMINE',
    ...
    hidden_loss_loading_body: 'NORTHMINE wird geladen...',
    ...
    hidden_loss_sin_respuesta: 'Keine Antwort von NORTHMINE',
    ...
    nlp_loading_body: 'NORTHMINE wird geladen...',
    ...
    nlp_sin_respuesta: 'Keine Antwort von NORTHMINE',
    ...
    audit_loading_body: 'NORTHMINE wird geladen...',
    ...
    audit_sin_respuesta: 'Keine Antwort von NORTHMINE',
    ...
    sc_no_data_detail: (id) => `NORTHMINE hat keine stündlichen Details für ${id} geliefert. Es werden keine Daten erfunden.`,
    sc_col_slot: 'Slot',
