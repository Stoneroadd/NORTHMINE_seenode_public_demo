...
export const publicPagesT: ModuleDict<PublicPagesT> = {
  es: {
    ...
    preview: {
      ...
      mapFigcaption: 'Ortomosaico sintético original con una capa de geometría minera. No representa una faena ni datos operacionales reales.',
    },
    disclosure: {
    ...
    requestForm: {
      ...
      errApi422: 'Uno o más campos requieren revisión. Comprueba los datos ingresados.',
  ...
  en: {
    ...
    preview: {
      ...
      mapFigcaption: 'Original synthetic orthomosaic with a synthetic mine-geometry layer. It does not represent a real site or operational data.',
    },
    disclosure: {
    ...
    requestForm: {
      ...
      errApi422: 'One or more fields require review. Check the information entered.',
  ...
  de: {
    ...
    preview: {
      ...
      mapFigcaption: 'Originales synthetisches Orthofoto mit einer synthetischen Grubengeometrie. Stellt keine reale Grube oder Betriebsdaten dar.',
    },
    disclosure: {
    ...
    requestForm: {
      ...
      errApi422: 'Ein oder mehrere Felder müssen geprüft werden. Überprüfen Sie die eingegebenen Daten.',
  ...
  zh: {
    ...
    preview: {
      ...
      mapFigcaption: '原创合成正射影像，包含合成矿山几何图层。不代表真实矿场或运营数据。',
    },
    disclosure: {
      eyebrow: '环境诚实',
      title: '此演示包含什么',
    ...
    requestForm: {
      ...
      errApi422: '一个或多个字段需要检查，请确认输入的信息。',
  ...
  ar: {
    ...
    preview: {
      ...
      mapFigcaption: 'صورة جوية اصطناعية أصلية بطبقة هندسة منجم اصطناعية. لا تمثل منجماً ولا بيانات تشغيلية حقيقية.',
    },
    disclosure: {
      eyebrow: 'صدق البيئة',
  ...
  ru: {
    ...
    preview: {
      ...
      mapFigcaption: 'Оригинальный синтетический ортофотоплан со слоем синтетической геометрии рудника. Не представляет реальный рудник или операционные данные.',
    },
    disclosure: {
    ...
    requestForm: {
      ...
      errApi422: 'Одно или несколько полей требуют проверки. Проверьте введённые данные.',
