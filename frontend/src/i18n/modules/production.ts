...
export const productionT: ModuleDict<ProductionT> = {
  es: {
    ...
    sin_produccion_message: (system) => `No hay produccion para el turno actual. La API respondio desde ${system}; no se muestran datos sinteticos automaticamente.`,
  ...
  en: {
    ...
    sin_produccion_message: (system) => `There is no production for the current shift. The API responded from ${system}; synthetic data is not shown automatically.`,
  ...
  de: {
    ...
    sin_produccion_message: (system) => `Fuer die aktuelle Schicht gibt es keine Produktion. Die API hat von ${system} geantwortet; synthetische Daten werden nicht automatisch angezeigt.`,
