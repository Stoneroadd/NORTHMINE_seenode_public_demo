...
export const dashboardT: ModuleDict<DashboardT> = {
  es: {
    ...
    error_message_network: 'No es posible actualizar los datos en este momento. Reintentando automaticamente.',
    error_message_server: 'Error del servidor. Intenta recargar la pagina.',
    reload_button: 'Recargar',
    section_placeholder_title: 'Capacidad disponible próximamente',
    section_placeholder_desc: 'La navegacion ya esta definida. Los modulos especializados consumen datos reales de WENCO/SQL.',
    filters_title: 'Filtros dashboard',
    data_confidence_aria: 'Estado de datos del dashboard',
    confidence_backend: 'Sistema',
  ...
  en: {
    ...
    error_message_network: 'We could not refresh the data right now. Retrying automatically.',
    error_message_server: 'Server error. Try reloading the page.',
    reload_button: 'Reload',
    section_placeholder_title: 'Capability available soon',
    section_placeholder_desc: 'Navigation is already defined. Specialized modules consume real WENCO/SQL data.',
    filters_title: 'Dashboard filters',
    data_confidence_aria: 'Dashboard data status',
    confidence_backend: 'System',
  ...
  de: {
    section_label: {
      ...
      carguio: 'Beladung',
      averias: 'Ausfälle',
      analisis: 'Expertenanalyse',
      aerea: 'Luftansicht',
      alertas: 'Alarme',
      reportes: 'Berichte',
      admin: 'Admin',
    },
    error_title_401: 'Ungültige Sitzung',
    error_title_generic: 'Das Dashboard konnte nicht geladen werden',
    error_message_401: 'Ihre Sitzung ist abgelaufen. Laden Sie die Seite neu, um sich erneut anzumelden.',
    error_message_network: 'Die Daten konnten derzeit nicht aktualisiert werden. Automatischer erneuter Versuch läuft.',
    error_message_server: 'Serverfehler. Versuchen Sie, die Seite neu zu laden.',
    reload_button: 'Neu laden',
    section_placeholder_title: 'Funktion demnächst verfügbar',
    section_placeholder_desc: 'Die Navigation ist bereits definiert. Die Spezialmodule nutzen echte WENCO/SQL-Daten.',
    filters_title: 'Dashboard-Filter',
    data_confidence_aria: 'Datenstatus des Dashboards',
    confidence_backend: 'System',
    confidence_shift_data: 'Schichtdaten',
    confidence_monthly_plan: 'Monatsplan',
    confidence_f02_apart: 'F02 separat',
    confidence_alerts: 'Alarme',
    confidence_updated: 'Aktualisiert',
    status_online: 'ONLINE',
    status_checking: 'PRÜFT',
    status_not_configured: 'NICHT KONFIGURIERT',
    status_configured: 'KONFIGURIERT',
    status_no_f02: 'Ohne F02',
    status_partial: 'TEILWEISE',
    status_syncing: 'SYNCHRONISIERT',
    status_ok: 'OK',
    hero_kicker: 'Plan & Performance Center',
    hero_title: 'Was ich brauche, um im grünen Bereich abzuschließen',
    hero_configure_plan: 'Konfigurieren Sie den Monatsplan F01, um den Abschluss im grünen Bereich zu bewerten.',
    hero_status_label: 'Status Abschluss F01',
    hero_no_plan: 'Ohne Plan',
    hero_vs_accumulated: (pct) => `${pct} vs. kumuliert`,
    hero_plan_required: 'Erforderlicher Plan',
    hero_required_remaining: 'Restbedarf',
    hero_required_remaining_small: 'Aktuelles Tempo vs. erforderlich',
    hero_current_average: 'Aktueller Durchschnitt',
    hero_current_average_small: 'Prognose gegenüber Monatsziel',
    hero_accumulated_diff: 'Kumulierte Differenz',
    hero_accumulated_diff_small_positive: 'Über kumuliertem Tempo',
    hero_accumulated_diff_small_negative: 'Kumulierte Lücke',
    market_strip_aria: 'Puls der monatlichen Zielerreichung',
    plan_kicker: 'Kumulierte Zielerreichung',
    plan_title: 'F01 / F02 / Prognose',
    causes_kicker: 'Ursachen, die den Plan gefährden können',
    causes_title: 'Executive-Priorität',
    causes_tag: (n) => `${n} Brennpunkte`,
    causes_vs_reference: (pct) => `${pct} vs. Referenz`,
    causes_impact_detail: (impact, detail) => `Geschätzte Auswirkung ${impact} - ${detail}`,
    causes_empty: 'Keine relevanten Abweichungen gegenüber der Referenz.',
    standby_kicker: 'Gerechtfertigter Standby',
    standby_title: 'Flotte außerhalb der Leistung',
    standby_tag: (n) => `${n} Geräte`,
    standby_operator: (op) => `Operator ${op}`,
    standby_no_operator: 'Kein Operator erfasst',
    standby_minutes_inactive: (min) => ` · ${min} Min ohne Zyklus`,
    standby_empty: 'Keine Geräte im WENCO-Standby. Geräte ohne Beitrag werden als geringe Leistung oder Wartung bewertet.',
    standby_note: 'Diese Geräte werden vom Ranking der geringen Leistung ausgeschlossen, da WENCO sie als Standby/Flottenmanagement-Unterstatus erfasst.',
    insight_kicker: 'Executive-Auswertung',
    insight_title: 'Was die Abweichung erklärt',
    insight_empty: 'Betrieb ohne relevante Führungsabweichungen.',
    scope_kicker: 'Umfangshinweise',
    scope_title: 'Keine Duplikation des Cockpits',
    scope_note_cockpit: 'Cockpit: Schicht und Geräte live betreiben.',
    scope_note_dashboard: 'Dashboard: Planzielerreichung und Monatsabschluss bestätigen.',
    scope_note_f02: 'F02 wird separat gemeldet und nur als operativer Gesamtwert hinzugerechnet.',
    kpi_shift_title: 'Schichtproduktion',
    kpi_shift_subtitle: (turno, ciclos, avance) => `${turno} / ${ciclos} Zyklen${avance ? ` / ${avance} Fortschritt` : ''}`,
    kpi_shift_trend: (compliance, inProgress) => inProgress ? `${compliance} Endziel` : compliance,
    kpi_status_on_track: 'Auf Kurs',
    kpi_status_close_risk: 'Abschlussrisiko',
    kpi_status_in_control: 'Unter Kontrolle',
    kpi_status_attention: 'Aufmerksamkeit',
    kpi_comparison_projected: (v) => `Prognose ${v}`,
    kpi_comparison_expected_now: (v) => `Jetzt erwartet ${v}`,
    kpi_comparison_target: (v) => `Ziel ${v}`,
    kpi_comparison_shift_target: 'Schichtziel',
    kpi_day_title: 'Tagesproduktion',
    kpi_day_subtitle: (date) => `F01 ${date}`,
    kpi_day_subtitle_no_data: 'Keine Tagesdaten',
    kpi_day_no_plan: 'Ohne Plan',
    kpi_day_status_over_plan: 'Über Plan',
    kpi_day_status_preventive: 'Präventiv',
    kpi_day_status_critical: 'Kritisch',
    kpi_day_status_no_daily_plan: 'Ohne Tagesplan',
    kpi_day_comparison_daily_target: (v) => `Tagesziel ${v}`,
    kpi_day_comparison_real_only: 'Nur tatsächlich beobachtet',
    kpi_accumulated_title: 'Kumuliert F01',
    kpi_accumulated_subtitle: (days) => `${days} bewertete Tage`,
    kpi_accumulated_no_plan: 'Ohne Plan',
    kpi_accumulated_status_over: 'Über kumuliert',
    kpi_accumulated_status_under: 'Unter kumuliert',
    kpi_accumulated_status_not_configured: 'Plan nicht konfiguriert',
    kpi_accumulated_comparison: (v) => `Kum. geplant ${v}`,
    monthly_kpi_planned_title: 'Kumuliert geplant',
    monthly_kpi_planned_subtitle: (days) => `${days} Tage × Tagesziel F01`,
    monthly_kpi_planned_trend: (v) => `${v}/Tag`,
    monthly_kpi_planned_status: 'Plan in Kraft',
    monthly_kpi_planned_comparison: (v) => `Monatsziel ${v}`,
    monthly_kpi_diff_title: 'Kumulierte Differenz',
    monthly_kpi_diff_subtitle: 'F01 real vs. geplant bis heute',
    monthly_kpi_diff_trend_over: 'Über dem Tempo',
    monthly_kpi_diff_trend_recover: 'Aufholen',
    monthly_kpi_diff_status_green: 'Grün',
    monthly_kpi_diff_status_preventive: 'Präventiv',
    monthly_kpi_diff_status_critical: 'Kritisch',
    monthly_kpi_diff_comparison: (pct) => `${pct} kumuliert`,
    monthly_kpi_required_title: 'Erforderlich für Grün',
    monthly_kpi_required_subtitle: (days) => `${days} verbleibende Tage`,
    monthly_kpi_required_trend_ok: 'Ausreichendes Tempo',
    monthly_kpi_required_trend_raise: 'Tempo erhöhen',
    monthly_kpi_required_status_ok: 'Im grünen Bereich',
    monthly_kpi_required_status_risk: 'Abschlussrisiko',
    monthly_kpi_required_comparison: (v) => `Aktueller Ø ${v}/Tag`,
    monthly_kpi_no_plan_title: 'Monatsplan',
    monthly_kpi_no_plan_value: 'Nicht konfiguriert',
    monthly_kpi_no_plan_subtitle: 'Die monatliche Bewertung ist deaktiviert',
    monthly_kpi_no_plan_trend: 'Ohne Ziel',
    monthly_kpi_no_plan_status: 'Nicht bewertbar',
    monthly_kpi_no_plan_comparison: 'Offiziellen Monatsplan laden',
    driver_f01_label: 'F01 real kumuliert',
    driver_f01_meta: (v) => `vs. ${v} geplant`,
    driver_f02_label: 'F02 separat',
    driver_f02_meta: (v) => `Operativer Gesamtwert ${v}`,
    driver_projection_label: 'F01-Prognose',
    driver_projection_meta: (v) => `${v} vs. Monatsziel`,
    action_maintain_rate: (v) => `Halten Sie mindestens ${v}/Tag F01 ein, um im grünen Bereich abzuschließen.`,
    action_raise_rate: (v) => `Erhöhen Sie das Tempo auf ${v}/Tag F01, um im grünen Bereich abzuschließen.`,
    action_configure_plan: 'Konfigurieren Sie den offiziellen Monatsplan, um Zielerreichung und Monatsprognose zu aktivieren.',
    action_correct_equipment: (equipment, impact) => `Korrigieren Sie ${equipment}; geschätzte Auswirkung ${impact}.`,
    action_maintain_loading: 'Beladungskontinuität aufrechterhalten und Abweichungen beim Abschluss prüfen.',
    action_maintain_shift: 'Schichtkontinuität aufrechterhalten; die Prognose übersteigt das aktuelle Ziel.',
    action_recover_shift: 'Tempo der Schicht vor dem nächsten Stundenende aufholen.',
    green_status_no_plan: 'Ohne Plan',
    green_status_on_green: 'Im grünen Bereich',
    green_status_recoverable: 'Aufholbar',
    green_status_at_risk: 'Gefährdet',
    green_summary: (status, requiredDaily, monthlyTarget, currentAvg) => `${status}: Sie benötigen ${requiredDaily} F01/Tag, um ${monthlyTarget} zu erreichen. Aktuelles Tempo ${currentAvg}/Tag.`,
  },
}
