...
export const dashboardT: ModuleDict<DashboardT> = {
  ...
  de: {
    ...
    error_message_network: 'Die Verbindung zum Backend unter http://localhost:8001 ist nicht möglich. Stellen Sie sicher, dass der echte Server läuft.',
    ...
    section_placeholder_desc: 'Die Navigation ist bereits definiert. Die Spezialmodule nutzen FastAPI mit echten WENCO/SQL-Daten.',
