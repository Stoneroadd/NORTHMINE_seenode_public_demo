...
export const dashboardT: ModuleDict<DashboardT> = {
  es: {
    ...
    error_message_network: 'No se puede conectar al backend local. Cierra procesos NORTHMINE anteriores y vuelve a abrir el ejecutable.',
  ...
  en: {
    ...
    error_message_network: 'Cannot connect to the local backend. Close previous NORTHMINE processes and reopen the executable.',
