...
export const originT: ModuleDict<OriginT> = {
  es: {
    ...
    hero: {
      ...
      lead: 'Cómo quince años en minería —desde la primera línea de planta hasta una sala de despacho— dieron origen a una plataforma de inteligencia operacional.',
  ...
  en: {
    ...
    hero: {
      ...
      lead: 'How fifteen years in mining —from the first line of a plant to a dispatch room— gave rise to an operational intelligence platform.',
  ...
  de: {
    ...
    hero: {
      ...
      lead: 'Wie fünfzehn Jahre im Bergbau —von der ersten Linie einer Anlage bis zum Dispositionsraum— eine Plattform für operative Intelligenz hervorbrachten.',
  ...
  zh: {
    ...
    hero: {
      ...
      title1: '我不是从写软件开始的。',
      title2: '我是从搬运矿石开始的。',
      lead: '十五年的矿业经历——从工厂一线到调度室——如何孕育出一个运营智能平台。',
      ctaHistoria: '开始故事',
  ...
  ar: {
    ...
    hero: {
      ...
      lead: 'كيف أدّت خمسة عشر عاماً في التعدين —من أولى خطوط المصنع إلى غرفة التوزيع— إلى منصة ذكاء تشغيلي.',
  ...
  ru: {
    ...
    hero: {
      ...
      lead: 'Как пятнадцать лет в горной добыче — от первой линии завода до диспетчерской — привели к созданию платформы операционного интеллекта.',
