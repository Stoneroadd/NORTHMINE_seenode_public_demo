...
export const equipmentT: ModuleDict<EquipmentT> = {
  es: {
    ...
    checkBackendRetry: 'Intenta nuevamente en unos segundos.',
    close: 'Cerrar',
    ...
    readyForDrilldown: 'El detalle adicional se habilitará cuando la fuente lo permita.',
  ...
  en: {
    ...
    checkBackendRetry: 'Try again in a few seconds.',
    close: 'Close',
    ...
    readyForDrilldown: 'Additional detail will be enabled when the source allows it.',
  ...
  de: {
    alertsAssociated: 'Zugehörige Alarme',
    operationalRisk: 'Operatives Risiko',
    activeAlerts: (n) => `${n} aktive`,
    noActiveAlerts: 'Keine aktiven Alarme zugeordnet zu diesem Gerät.',
    operatingCycle: 'Betriebszyklus',
    timeBreakdown: 'Zeitaufschlüsselung',
    totalMin: (n) => `${n} Min. gesamt`,
    noData: 'Keine Daten',
    minValue: (n) => `${n} Min.`,
    emptyTravel: 'Leerfahrt',
    loadTravelUnload: 'Beladen + beladene Fahrt + Entladen',
    equipmentDetailAria: 'Gerätedetail',
    closeDetailAria: 'Detail schließen',
    loadingOperationalDetail: 'Operatives Detail wird geladen...',
    couldNotLoadEquipment: 'Das Gerät konnte nicht geladen werden',
    checkBackendRetry: 'Versuchen Sie es in Kürze erneut.',
    close: 'Schließen',
    operationalDetail: 'Operatives Detail',
    ...
    hourlyHistory: 'Stündlicher Verlauf',
    tonsAndCycles: 'Tonnen und Zyklen',
    currentShift: 'Aktuelle Schicht',
    tons: 'Tonnen',
    cycles: 'Zyklen',
    tonsShift: 'Schicht-Tonnen',
    operationalContribution: 'operativer Beitrag',
    cyclesShift: 'Schicht-Zyklen',
    realCycles: 'tatsächliche Zyklen',
    performance: 'Leistung',
    tonsPerHour: 'Tonnen pro Stunde',
    availability: 'Verfügbarkeit',
    mechanicalState: 'mechanischer Zustand',
    utilization: 'Auslastung',
    shiftUsage: 'Schichtnutzung',
    delays: 'Verzögerungen',
    currentStateAccumulated: 'kumuliert im aktuellen Zustand',
    alerts: 'Alarme',
    associated: 'zugeordnet',
    noDataAvailable: 'in WENCO nicht verfügbar',
    recommendation: 'Empfehlung',
    suggestedAction: 'Vorgeschlagene operative Maßnahme',
    readyForDrilldown: 'Weitere Details werden verfügbar, sobald die Quelle sie bereitstellt.',
    viewOperationalDetail: (id) => `Operatives Detail anzeigen ${id}`,
    quickAnalysis: 'Schnellanalyse',
    operatorLabel: (name) => `Operator ${name}`,
    noOperatorData: 'Keine Operator-Daten',
    reviewRestriction: 'Operative Einschränkung prüfen.',
    prioritizeDispatch: 'Maßnahme der Disposition priorisieren.',
    operationWithinRange: 'Betrieb innerhalb des Bereichs.',
    featuredEquipment: 'Hervorgehobenes Gerät',
  },
}
