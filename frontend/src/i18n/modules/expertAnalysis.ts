...
export const expertAnalysisT: ModuleDict<ExpertAnalysisT> = {
  ...
  de: {
    loading_label: 'Verknüpfe Produktion und Wartung...',
    error_detail: 'Die Expertenanalyse konnte nicht geladen werden.',
    eyebrow: 'Expertenanalyse',
    title: 'Produktion x Wartung, einfach erklärt',
    description: 'Jede Karte beantwortet eine Geschäftsfrage anhand der realen historischen Daten.',
    cycles_historized: (count, from, to) => `${count} historisierte Zyklen (${from} bis ${to})`,

    no_history_yet: 'Noch nicht genügend Verlauf für die Analyse vorhanden. Die Zyklen werden automatisch gesammelt.',

    cost_of_unavailability_kicker: 'Kosten der Nichtverfügbarkeit',
    lost_tons_by_breakdowns_title: 'Durch Ausfälle verlorene Tonnen, je Gerät',
    total_label: (tons) => `Gesamt: ${tons}`,
    lost_tons_explanation: 'Berechnungsweise: was das Gerät an einem normalen Tag bewegt x die Tage, an denen es wegen eines Ausfalls stillstand. Es handelt sich um eine theoretische Obergrenze (ein Teil der Last wird von anderen Geräten übernommen), aber sie priorisiert nach Geld, nicht nach Stunden.',
    lost_tons_detail: 'Detail: Stillstandstage x durchschnittliche Tagesproduktion je Gerät (nur korrektive Ausfälle).',

    maintenance_quality_kicker: 'Wartungsqualität',
    breakdowns_after_pm_title: 'Ausfälle direkt nach einer PM',
    pct_within_7_days: (pct) => `${pct}% innerhalb von 7 Tagen`,
    no_data_tag: 'keine Daten',
    breakdowns_after_pm_explanation: 'Fällt ein Gerät wenige Tage nach der geplanten Wartung aus, hat der Eingriff das zugrunde liegende Problem wahrscheinlich nicht gelöst. Dies sind die Geräte, bei denen es am häufigsten auftritt:',
    case_singular: 'Fall',
    case_plural: 'Fälle',
    no_repeated_cases: 'Keine wiederholten Fälle im Fenster.',

    backtesting_kicker: 'Backtesting',
    shift_target_vs_reality_title: 'Das Schichtziel gegen die Realität',
    shifts_analyzed: (count) => `${count} Schichten`,
    current_target: 'Aktuelles Ziel',
    typical_shift: 'Typische Schicht (reale Mediane)',
    times_met: 'Anzahl der Zielerreichungen',
    demand_percentile: 'Anforderung (Perzentil)',
    out_of_100: (percentile) => `${percentile} von 100`,
    percentile_reading_hint: 'Lesart: niedriges Perzentil = leichtes Ziel (fast alle Schichten übertreffen es); Perzentil 40-75 = anspruchsvoll, aber erreichbar; über 75 = wird selten erreicht und demotiviert.',
    needs_more_shifts: 'Es werden mindestens 10 historisierte Schichten benötigt.',
  },
}
